...
<body>
  ...
  <div class="card-body">
    ...
    <ul class="list-group">
  <li class="list-group- ourItem">Cras justo odio</li>
  <li class="list-group- ourItem">Dapibus ac facilisis in</li>
  <li class="list-group- ourItem">Morbi leo risus</li>
  <li class="list-group- ourItem">Porta ac consectetur ac</li>
  <li class="list-group- ourItem">Vestibulum at eros</li>
</ul>
    <p class="card-text"></p>
